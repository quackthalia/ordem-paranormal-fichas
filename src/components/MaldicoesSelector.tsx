                ...
                opcoesDisponiveis.map(opcao => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {opcao.Efeito && (
                        <span className="text-[11px] text-green-400 mt-1.5 italic">
                          {opcao.Efeito}
                        </span>
                      )}
                    </div>
        ...
        {aplicadas.map((mod, index) => {
          ...
          return (
            <div 
              ...
              className="group flex items-start justify-between p-3 bg-zinc-900/40 hover:bg-zinc-900/60 border border-zinc-800 hover:border-green-900/50 rounded-lg transition-all"
            >
              <div className="flex flex-col gap-1.5 pr-4">
                ...
                {mod.Efeito && (
                  <p className="text-[10px] text-green-400 italic">Efeito: {mod.Efeito}</p>
                )}
              </div>
              <button
                type="button"
