...
export const ModalPoderOutraClasse: React.FC<{ isOpen: boolean; onClose: () => void; categoriaPermitida?: 'combate' | 'utilidade' | 'gerais' }> = ({ isOpen, onClose, categoriaPermitida }) => {
  ...
  const renderPoder = (poder: any) => {
              ...
              return (
                <div key={poder.codigo_poder} className={`bg-zinc-900/40 border border-zinc-800/80 rounded p-3 hover:border-green-500/50 hover:bg-zinc-900/80 transition group flex flex-col min-h-[220px]`}>
