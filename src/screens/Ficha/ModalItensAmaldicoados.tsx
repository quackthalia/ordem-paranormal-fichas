                ...
                {itensFiltrados.filter((_, i) => i % 2 === 0).map(item => {
                  ...
                  return (
                    <div 
                      ...
                      className={`bg-zinc-900/40 border border-zinc-800/80 rounded p-3 hover:border-green-500/50 hover:bg-zinc-900/80 transition group flex flex-col  min-h-[150px]`}
                    >
